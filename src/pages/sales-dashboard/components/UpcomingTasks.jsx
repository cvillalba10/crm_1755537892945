...
const UpcomingTasks = () => {
  const [tasks, setTasks] = useState([
    {
      id: 1,
      title: 'Seguimiento con Acme Corp',
      description: 'Enviar propuesta de precio y agendar visita',
    ...
    {
      id: 2,
      title: 'Visita con FutureTech',
      description: 'Mostrar propiedad y sesión de preguntas',
    ...
    {
      id: 3,
      title: 'Enviar contrato a MegaCorp',
      description: 'Revisión final del contrato y firma',
    ...
    {
      id: 4,
      title: 'Revisión trimestral con Global Systems',
      description: 'Revisar progreso de implementación y próximos pasos',
    ...
    {
      id: 5,
      title: 'Actualizar CRM para negociación TechStart',
      description: 'Añadir notas de reunión y próximas acciones',
  ...
  return (
    <div className="card p-6">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-text-primary">Próximas Tareas</h3>
